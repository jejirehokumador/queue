    ...
    <form class="tabs-wrap">
        <div class="tab" id="tab1content">
            <div class="form-group col-sm-8" :class="{'has-error' : errors['purchase_code']}">
                ...
                <input type="text" name="puchase_code" id="puchase_code" placeholder="Enter random value" :readonly="show_details" v-model="purchase_code" />
            ...
            <div class="form-group col-sm-8" :class="{'has-error' : errors['codecanyon_username']}" style="margin-top:10px">
                ...
                <input type="text" name="codecanyon_username" id="codecanyon_username" :readonly="show_details" placeholder="raz0r" v-model="codecanyon_username" />
